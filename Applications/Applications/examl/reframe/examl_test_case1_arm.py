...
class ExaMLTest(hack.HackathonBase):
    ...
    executable_opts = ['-t /home/peize/examl-test/case1/49.tree -m PSR -s /home/peize/examl-test/case1/49.unpartitioned.binary -n T1']
    ...
    def set_sanity_patterns(self):
        ...
        expected_particle_lower = -15000
        expected_particle_upper = -14000
