...
class ExaMLTest(hack.HackathonBase):
    ...
    executable_opts = ['-t /home/peize/examl-test/case1/49.tree -m GAMMA -s /home/peize/examl-test/case1/49.unpartitioned.binary -n T1']
    ...
    def set_sanity_patterns(self):
        ...
        expected_particle_lower = -16721.368990
        expected_particle_upper = -15721.368990
