...
#        'cloverleaf@1.1 %nvhpc@21.2'      # CloverLeaf with the NVIDIA compiler
    ...
    def set_sanity_patterns(self):
       ...
       energy = sn.extractsingle(sol_regex, 'nwchem.out',1,float)

       energy_arm = -2840.723759484747

       # Perform a bounded assert
       self.sanity_patterns=   sn.assert_reference(energy,energy_arm, lower_thres=-0.0004, upper_thres=0.0004, msg=None)
