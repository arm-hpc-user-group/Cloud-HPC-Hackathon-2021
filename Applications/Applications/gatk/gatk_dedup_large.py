...
class GATKTest(hack.HackathonBase):
    ...
    log_test_name = f'gatk_dedup_large'

    # CLI args to use the Spark version of read counting 
    executable_opts = [
        '--java-options "-Xmx60g" MarkDuplicatesSpark -I /scratch/home/jayson/gatk-data/HG00096.wgs.ILLUMINA.bwa.GBR.high_cov_pcr_free.20140203.bam -O test.bam -M test_metrics.txt &> gatk.out'
    ]
    ...
    def set_config(self):
        pass
        # tried to make the JVM respect a scaling test!
