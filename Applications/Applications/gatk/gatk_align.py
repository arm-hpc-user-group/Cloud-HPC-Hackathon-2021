...
class GATKTest(hack.HackathonBase):
    ...
    executable_opts = [
        '--java-options "-Xmx60g" MarkDuplicates -I /scratch/home/jayson/gatk-data/H06HDADXX130110.1.ATCACGAT.20k_reads.bam -R /scratch/home/jayson/gatk-data/chr1.fa -O test.bam -M test_metrics.txt &> gatk.out'
    ...
    parallelism = parameter([
        ...
        #{ 'nodes' : 1, 'mpi' : 1, 'omp' : 1, 'extra-cmd': '0-63'},
        #{ 'nodes' : 1, 'mpi' : 1, 'omp' : 4, 'extra-cmd': '0-3'},
        #{ 'nodes' : 1, 'mpi' : 1, 'omp' : 8, 'extra-cmd': '0-7'},
        #{ 'nodes' : 1, 'mpi' : 1, 'omp' : 16, 'extra-cmd': '0-15'},
        #{ 'nodes' : 1, 'mpi' : 1, 'omp' : 32, 'extra-cmd': '0-31'},
        #{ 'nodes' : 1, 'mpi' : 1, 'omp' : 36, 'extra-cmd': '0-63'},
    ])
    ...
    def set_sanity_patterns(self):
        ...
        expected_count_regex = r'(MarkDuplicates)'
        ...
        self.sanity_patterns = sn.assert_eq(expected_count, 'MarkDuplicates') 
        ...
        perf_regex = r'MarkDuplicates done. Elapsed time: (\S+) minutes'
        self.perf_patterns = {
