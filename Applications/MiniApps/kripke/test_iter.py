...
class KripkeTest(hack.HackathonBase):
    ...
    log_app_name = 'Kripke'
    log_test_name = 'more_iterations'

    # Define Execution
    # Binary to run
    executable = 'kripke.exe'
    # Command line options to pass
    executable_opts = ['--zones 32,32,32 --niter 20 > Kripke.out']
    ...
    def set_sanity_patterns(self):
        ...
        expected_particle_lower = 8.430210e+07
        expected_particle_upper = 8.430220e+07
