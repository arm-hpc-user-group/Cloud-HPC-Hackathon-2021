...
@rfm.simple_test
class MiniGMGOff1NodeTest4GCC(hack.HackathonBase): ###################################################
    ...
    log_test_name = 'minigmg_off_node1_test4_x86_gcc' ############################################

    # Define Execution
    # Binary to run
    executable = 'run.miniGMG'
    # Command line options to pass
    executable_opts = ['6 6 12 12 2 1 1']#, '> miniGMG.out'] ####################################
