...
@rfm.simple_test
class MiniGMGp4Test2ARM(hack.HackathonBase): ###################################################
    ...
    log_test_name = 'minigmg_performance4_test2_arm' ############################################

    # Define Execution
    # Binary to run
    executable = 'run.miniGMG'
    # Command line options to pass
    executable_opts = ['6 4 4 4 1 1 1']#, '> miniGMG.out'] ####################################
    ...
    def set_profiler(self):
        self.proffile = 'profileP4arm2.map' ###################################################
