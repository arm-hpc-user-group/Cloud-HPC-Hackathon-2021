...
```
$ spack install minitri%gcc@10.3.0
```

```
$ spack spec -Il minitri%gcc@10.3.0
...
Concretized
--------------------------------
[+]  idmhg7o  minitri@1.0%gcc@10.3.0+mpi arch=linux-amzn2-graviton2
...
```
$ spack install minitri%arm@21.0.0.879
```

```
$ spack spec -Il minitri%arm@21.0.0.879
...
```
$ spack install minitri%nvhpc@21.2
```

```
$ spack spec -Il minitri%nvhpc@21.2
...
Concretized
--------------------------------
[+]  kdmjeiz  minitri@1.0%nvhpc@21.2+mpi arch=linux-amzn2-graviton2
...
```
reframe -c minitri_short.py -r --performance-report
```
...
PERFORMANCE REPORT
------------------------------------------------------------------------------
miniTri_ca-GrQc_minitri__gcc_10_3_0_N_1_MPI_1_OMP_1
- aws:c6gn
   - builtin
      * num_tasks: 1
      * Total Time: 0.150996 s
------------------------------------------------------------------------------
miniTri_ca-GrQc_minitri__arm_21_0_0_879_N_1_MPI_1_OMP_1
   - builtin
      * num_tasks: 1
      * Total Time: 0.16961 s
------------------------------------------------------------------------------
miniTri_ca-GrQc_minitri__nvhpc_21_2_N_1_MPI_1_OMP_1
   - builtin
      * num_tasks: 1
      * Total Time: 0.169592 s
------------------------------------------------------------------------------
```
...
|  8     |  10.828    | 157.003| 92.993	|
|  16    |  10.119     | 6.636 | 33.976	|
|  32    |  9.366     | 7.231 | 92.953	|
|  64    |  102.834     | 12.680 | 66.038	|
|  128   |  293.267     | 110.745	| 131.558	|
|  256   |  306.568	 | 330.450	| 310.258  |
