...
class RemhosMathLibraryTuningTestBase(hack.HackathonBase):
    ...
    spec = parameter([
        'remhos@1.0%arm@21.0.0.879/q2vad4t', # OpenBLAS
        'remhos@1.0%arm@21.0.0.879/26rm5xy', # ArmPL
        'remhos@1.0%arm@21.0.0.879/3iu3o7u', # BLIS
    ])
...
@rfm.simple_test
class Remhos2DRemapMathLibraryTuningTest(RemhosMathLibraryTuningTestBase):
    log_test_name = 'Remhos2DRemapMathLibraryTuningTest'
...
@rfm.simple_test
class Remhos3DRemapMathLibraryTuningTest(RemhosMathLibraryTuningTestBase):
    log_test_name = 'Remhos3DRemapMathLibraryTuningTest'
...
@rfm.simple_test
class Remhos2DTransportMathLibraryTuningTest(RemhosMathLibraryTuningTestBase):
    log_test_name = 'Remhos2DTransportMathLibraryTuningTest'
...
@rfm.simple_test
class Remhos3DTransportMathLibraryTuningTest(RemhosMathLibraryTuningTestBase):
    log_test_name = 'Remhos3DTransportMathLibraryTuningTest'
