...
class RemhosCompilerTuningTestBase(hack.HackathonBase):
    ...
    spec = parameter([
        'remhos@1.0%arm@21.0.0.879/q2vad4t', # No flags
        'remhos@1.0%arm@21.0.0.879/orhbc67', # cppflags="-Ofast -mcpu=native -ffast-math" 
    ])
...
@rfm.simple_test
class Remhos2DRemapCompilerTuningTest(RemhosCompilerTuningTestBase):
    log_test_name = 'Remhos2DRemapCompilerTuningTest'
...
@rfm.simple_test
class Remhos3DRemapCompilerTuningTest(RemhosCompilerTuningTestBase):
    log_test_name = 'Remhos3DRemapCompilerTuningTest'
...
@rfm.simple_test
class Remhos2DTransportCompilerTuningTest(RemhosCompilerTuningTestBase):
    log_test_name = 'Remhos2DTransportCompilerTuningTest'
...
@rfm.simple_test
class Remhos3DTransportCompilerTuningTest(RemhosCompilerTuningTestBase):
    log_test_name = 'Remhos3DTransportCompilerTuningTest'
