...
class RemhosArchComparisonTestBase(hack.HackathonBase):
...
class Remhos3DRemapArchComparisonTest(RemhosArchComparisonTestBase):
    log_test_name = 'Remhos3DRemapArchComparisonTest'
...
@rfm.simple_test
class Remhos3DTransportArchComparisonTest(RemhosArchComparisonTestBase):
    log_test_name = 'Remhos3DTransportArchComparisonTest'
