...
# this test is number 4 in the verification table here: https://github.com/CEED/Laghos#verification-of-results


@rfm.simple_test
class LaghosTest1(hack.HackathonBase):
    ...
    executable_opts = ["-p", "1", "-dim", "3", "-rs",
                       "2", "-tf", "0.6", "-pa", ">", "laghos.out"]
    # executable_opts = []
    ...
    def set_sanity_patterns(self):
        ...
        self.sanity_patterns = sn.all([sn.assert_eq(lstep[0], 560), sn.assert_reference(
            lstep[2], 	0.002449, -0.0001, 0.0001), sn.assert_reference(lstep[3], 	1.3408616722e+02, -0.1, 0.1)])
